!function (p) {
    ...
    a || (a = 3e3), s || (s = 1);
    var c = { heading: t, text: i, position: o, loaderBg: e, icon: n, hideAfter: a, stack: s }; r && (c.showHideTransition = r), console.log(c), p.toast().reset("all"), p.toast(c)
    }, p.NotificationApp = new t, p.NotificationApp.Constructor = t
}(window.jQuery),
    function (i) {
    "use strict";
        
       i("#toastr-warning").on("click", function (t) { i.NotificationApp.send("Ocurrio un problema", "No se pudo realizar cambios", "top-right", "#da8609", "warning") }),
       i("#toastr-success").on("click",function (t) { i.NotificationApp.send("Guardado", "Se realizaron cambios exitosamente", "top-right", "#5ba035", "success") }),
       i("#toastr-danger").on("click", function (t) { i.NotificationApp.send("Error", "Imposible relaizar cambios. Intentar mas tarde", "top-right", "#bf441d", "error") }),

        i("#toastr-one").on("click", function (t) { i.NotificationApp.send("Heads up!", "This alert needs your attention, but it is not super important.", "top-right", "#3b98b5", "info") }),
        ...
        i("#toastr-four").on("click", function (t) { i.NotificationApp.send("Oh snap!", "Change a few things up and try submitting again.", "top-right", "#bf441d", "error") }),
